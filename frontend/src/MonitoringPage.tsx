                ...
                <section className="panel">
                    <div className="panel-header">
                        <div>
                            ...
                            <p>Grouped by pair and direction, live spread observed over the window (not realized profit).</p>
                        </div>
                    </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                {state.topOpportunities.length === 0 && (
                                    <EmptyRow columns={6} text="No historical opportunity episodes for selected window." />
                                )}
                            </tbody>
                        </table>
                    </div>
